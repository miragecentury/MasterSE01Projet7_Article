...
\author{Maite~COMPIEGNE,~\IEEEmembership{Student,~UPJV,}
        Victorien~VANROYE,~\IEEEmembership{Student,~UPJV,}}% <-this % stops a space
\thanks{Thank at all of the University of Picardie, France.}% <-this % stops a space
\thanks{J. Dubois}% <-this % stops a space
...
\begin{IEEEkeywords}
Sigfox, Object Connected, Geoloc
\end{IEEEkeywords}
...
\subsection{Présentation des deux design de carte}
...
\includegraphics[scale=0.18]{TP1204-1208.png} 
...
\subsection{Bilan de consommation entre les deux designs et une carte existante}
